...
public class StoreProvider {
    ...
    private static final int STORES = 100;
    ...
    static {
        ...
        sUriMatcher.addURI(StoreContract.CONTENT_AUTHORITY, StoreContract.PATH_FRAGRANCE, STORES);
...
//        sUriMatcher.addURI(FragranceContract.CONTENT_AUTHORITY, FragranceContract.PATH_CART, CART);
        ...
        sUriMatcher.addURI(StoreContract.CONTENT_AUTHORITY, StoreContract.PATH_FRAGRANCE + "/#", STORE_ID);
    ...
    public Cursor query(@NonNull Uri uri, @Nullable String[] projection, @Nullable String selection, @Nullable String[] selectionArgs, @Nullable String sortOrder) {
        ...
        switch (match) {
            case STORES:
                ...
                cursor = database.query(StoreContract.FragranceEntry.TABLE_NAME, projection, selection, selectionArgs,
                        null, null, sortOrder);
//                break;
//            case CART:
...
//                break;
            case STORE_ID:
                ...
                selection = StoreContract.FragranceEntry._ID + "=?";
                selectionArgs = new String[] { String.valueOf(ContentUris.parseId(uri)) };
...
//    }
    ...
    public int delete(@NonNull Uri uri, @Nullable String s, @Nullable String[] strings) {
        ...
        final SQLiteDatabase db = storeDbHelper.getWritableDatabase();
